...
public class MasterTokenProvider implements MasterTokenService {
    ...
    private static final String DATABASE = "Tenants";
    private static final String COLLECTION = "Tenants";

    private static final String MASTER_KEY = "ACtCofBe5117Z5S6yXjkOqaqKN5znQEMlorMSeSj0Wvdm66IaD4VDpmBTehiasSTqmh8ZrG5ainYqFsA7gA1kA==";
        ...
        String role)
    {
        ...
        String headerValue = String.format("type=%s&ver=%s&sig=%s&role=%s",
            keyType,  
            tokenVersion,  
            signature,
            role);
